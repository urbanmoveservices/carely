...
export const E2E_CHECK_TO_QA: Record<string, string | string[]> = {
  ...
  usage_server_period_utc: "billing_usage_counters",
  upload_limit_server_side: "billing_usage_counters",
  ai_summary_limit_server_side: "billing_usage_counters",
  family_limit_server_side: "billing_usage_counters",
  expired_plan_falls_back_free: "billing_usage_counters",
