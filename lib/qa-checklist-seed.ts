...
export const QA_CHECKLIST_ITEMS: QaSeedItem[] = [
  ...
  item("auth", "forgot_password", "Forgot password", "Request reset email or dev link"),
  item("auth", "reset_password", "Reset password", "Token reset flow works"),
  item("auth", "verify_email", "Email verification", "Verify token marks email verified"),
